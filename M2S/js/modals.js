...
function usermod(text){
	$(document.body).append('<div class="modal fade user-info in" tabindex="-1" role="dialog" aria-hidden="true"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><h3 class="modal-title">Profile info</h3></div><div class="modal-body"></div></div></div></div>');
